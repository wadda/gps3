...
# as "host='sypy.ddns.net'" will not be up forever. 20141201 Psst, Line #13.
"""creates Keyhole (Google Earth) kml file (/tmp/gps3_live.kml) for realtime (4 second default) updates of gps coordinates"""
